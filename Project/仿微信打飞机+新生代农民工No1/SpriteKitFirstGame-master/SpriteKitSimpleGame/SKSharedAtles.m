...
+ (SKTexture *)textureWithType:(SKTextureType)type {
    switch (type) {
        ...
        case SKTextureTypeBigFoePlane:
            ...
            break;
        case SKTextureTypeFlyBullet:
            return [[[self class] shared] textureNamed:@"enemy5_fly_1.png"];
            break;
        case SKTextureTypeFlyBomb:
            return [[[self class] shared] textureNamed:@"enemy4_fly_1.png"];
            break;
